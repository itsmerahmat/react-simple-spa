      ...
      <div className="grid gap-10 lg:grid-cols-2">
        <div className="lg:pr-10">
          ...
          <p className="my-6 text-gray-900">
            Seorang anak yang suka ngikutin dan ngulik ngulik teknologi. Kalo
            kalian tertarik dibidang web boleh tuh buat tukar pendapat dengan
            saya dan kalo mau, bisa tuh kita bikin project bareng wkwk.
          </p>
